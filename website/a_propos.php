...
if (isset($_COOKIE['username']) && isset($_COOKIE['pass'])) {
	...
	if (!$error) {
		...
		if ($query_check_cookie->rowCount() == 1){
            ...
            $smarty->assign("description", "Cette page contient les informations relatives au site internet");
            ...
            $bubbles['Mission'] = "La mission de CTS est simple : mettre en relation des entreprises et des étudiants du monde entier pour trouver la meilleure offre et le meilleur stagiaire  .";
            $bubbles['Qui sommes-nous ?'] = "Un groupe de projet composé de Justine ADLER, Louis DUMONT, Nathan KISS et Nicolas WIRA.";
